                                                        ...
                                                        <form action="{{ url('ketua/anggota', $anggota->id) }}"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <input type="hidden" name="keterangan" class="form-control"
                                                                    value="Sedang diajukan kepada admin ">
                                                            </div>
                                                            <div class="row">
                                                                <div class="form-group col-lg-4">
                                                                    <label for="" class="control-label">Tanggal Lahir</label>
                                                                ...
                                                                <div class="form-group col-lg-4">
                                                                    <label for="" class="control-label">Status</label>
                                                                    <select name="status" id="" class="form-control" value="{{$anggota->status}}">
                                                                        <option value="Umum">Umum</option>
                                                                        <option value="Pelajar">Pelajar</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-lg-4">
                                                                    <label for="" class="control-label">Bukti Pendaftaran</label>
                                                                    <input type="file" name="bukti_pendaftaran" class="form-control" value="{{url("public/$anggota->bukti_pendaftaran")}}">
                                                                    <div id="emailHelp" class="form-text">file gambar</div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
