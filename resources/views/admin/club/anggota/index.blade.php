                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header" style="background: #3b4268">
                                    ...
                                    <button type="button" class="close" style="color:aliceblue" data-dismiss="modal"><span>&times;</span>
                                    </button>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($list_anggota as $anggota)
                                        <tr>
                                            ...
                                            <td>{{ $anggota->status_registrasi }}</td>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-lg-5">
                                                                    ...
                                                                    <input type="text" name="nama"
                                                                        class="form-control" value="{{$anggota->nama}}" autocomplete="off">
                                                                </div>
                                                                <div class="form-group col-lg-4">
                                                                    <label for="" class="control-label">Nama
                                                                        Club</label>
